...
def _full_scorecard(**overrides) -> EvidenceScorecard:
    ...
    base = dict(
        ...
        bull_case_rationale="FY26 revenue guide +24% vs sector +9%.",
        bear_case_rationale="Channel checks flag Q3 order pause risk.",
        trend_technical_rationale="Above 50-DMA at 178 with RVOL 1.4x on May 1.",
        fundamental_quality_rationale="Gross margin 74.6% vs 5-yr median 68%.",
        liquidity_risk_rationale="Net cash $34B covers 2 years of capex.",
        catalyst_clarity_rationale="Earnings 2026-05-28 inside the horizon.",
        macro_regime_rationale="Semis sector RS rank 92 vs SPY.",
        valuation_rationale="FY27 PE 28x vs 5-yr median 32x; fairly priced.",
...
class TestPortfolioDecisionContractsRegression:
    ...
    def test_slice4_triangulation_note_rendered_on_strong_scorecard_hold(self):
        ...
        sc = EvidenceScorecard(
            ...
            confidence=Confidence.MEDIUM,
            bull_case_rationale="Order book +18% QoQ on supplier guide.",
            bear_case_rationale="Bear scenario flags margin compression risk.",
            trend_technical_rationale="50-DMA cluster at 178 holding on RVOL.",
            fundamental_quality_rationale="ROCE 24% above sector median 16%.",
            liquidity_risk_rationale="Net debt zero; 1.6x current ratio.",
            catalyst_clarity_rationale="Earnings 2026-05-28 inside the horizon.",
            macro_regime_rationale="Index trend up; FII inflows positive.",
            valuation_rationale="PEG 1.4x at 22% growth consensus.",
